  ...
  return <div className="form-page">
    ...
    <form onSubmit={submit} className="project-form">
      <fieldset disabled={busy}>
        ...
        </div><div className="inline-note"><Globe2 size={19} /><p>Only public pages are fetched. Each website’s robots rules are checked before crawling. Your website settings control collection; analysis uses selected saved text.</p></div></section>}
      </fieldset>
